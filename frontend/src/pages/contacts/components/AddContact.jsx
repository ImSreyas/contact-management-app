...
export default function AddContact({ onContactAdded }) {
  ...
  const onSubmit = async (data) => {
    ...
    if (res?.success) {
      ...
      myToast("error", res?.message || "Failed to add contact");
    }
  };
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="min-w-4xl max-w-[90vw] max-h-[85vh] overflow-y-auto">
        <DialogHeader className="">
          <DialogTitle className="">Add New Contact</DialogTitle>
          <DialogDescription />
        </DialogHeader>
        <form
        ...
        >
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              <Label htmlFor="firstName" required className="pb-1">
                First Name
              </Label>
              <Input
                className={undefined}
            ...
            <div className="space-y-1">
              <Label htmlFor="lastName" required className="pb-1">
                Last Name
              </Label>
              <Input
                className={undefined}
          ...
          <div className="space-y-1 w-1/2">
            <Label htmlFor="address" required className="pb-1">
              Address
            </Label>
            <Textarea
              className={undefined}
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1">
              <Label htmlFor="location" required className="pb-1">
                Location
              </Label>
              <Input
                className={undefined}
            ...
            <div className="space-y-1">
              <Label htmlFor="company" required className="pb-1">
                Company
              </Label>
              <Input
                className={undefined}
